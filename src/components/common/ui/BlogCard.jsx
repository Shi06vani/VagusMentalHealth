  ...
  return (
    <div className="rounded-xl font-poppins overflow-hidden shadow-lg bg-white shadow-[#00000026]  flex flex-col h-full">
      ...
      <div className="p-5 flex flex-col flex-1">
        <h3 className="text-base lg:text-lg font-semibold text-[#094C9F] mb-2">{title}</h3>
        ...
        <div className="mt-auto ">
          <a
            ...
            className="inline-block my-4 xl:my-10 bg-[#094C9F] font-normal hover:bg-[#094d9fde] text-xs text-white  sm:text-sm px-3 py-2 sm:px-6 sm:py-3  rounded-full"
          >
            Read More {">>"}
          </a>
        </div>
