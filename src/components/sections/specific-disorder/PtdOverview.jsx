...
const PtdOverview = () => {
  return (
    <div className="font-[Poppins] px-4  lg:px-6">
      <TherapyInfoSection
        introParagraphs={[
          "Panic attacks are sudden episodes of intense fear or discomfort that can feel overwhelming and debilitating. They often come without warning and may be triggered by stress, trauma, or underlying anxiety disorders.",
