...
const PTsdTherapy = () => {
  return (
    <div className="font-[Poppins] px-4  lg:px-6">
      <TherapyInfoSection
        introParagraphs={[
          "Post-Traumatic Stress Disorder (PTSD) is a mental health condition triggered by experiencing or witnessing a traumatic event. It can develop after incidents such as accidents, violence, abuse, natural disasters, or military combat.",
          "PTSD can cause distressing memories, emotional numbness, and heightened anxiety, making daily life challenging. With the right support, therapy, and coping strategies, individuals can heal and regain control over their lives.",
        ]}
