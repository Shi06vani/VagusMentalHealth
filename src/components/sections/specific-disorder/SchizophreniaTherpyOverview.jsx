...
const SchizophreniaTherpyOverview = () => {
  return (
    <div className="font-[Poppins] px-4  lg:px-6">
      <TherapyInfoSection
        introParagraphs={[
          "Schizophrenia is a complex mental health disorder that affects a person’s thoughts, emotions, and perceptions of reality. Individuals with schizophrenia may experience hallucinations, delusions, disorganized thinking, and difficulty managing daily life.",
          "At Vagus Mind Health, we provide expert therapy and support to help manage symptoms and improve overall well-being.",
        ]}
        heading="Why Choose Vagus Mind Health is Best for Schizophrenia Treatment?"
...
export default SchizophreniaTherpyOverview;
