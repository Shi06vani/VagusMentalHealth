...
const CronicIllnessTherapy = () => {
  return (
    <div className="font-[Poppins]  px-4 lg:px-6">
      <TherapyInfoSection
        introParagraphs={[
          "Living with a chronic illness can be physically, emotionally, and mentally exhausting. The ongoing challenges of managing symptoms, medical treatments, and lifestyle adjustments can take a toll on mental well-being.",
          "It’s common to experience stress, anxiety, or even depression while navigating long-term health conditions.",
        ]}
...
export default CronicIllnessTherapy;
