  ...
  return (
    <div className="font-[Poppins]  px-4 lg:px-6">
      ...
      <div className="py-20">
        <CeoCard
          image={ceo}
          name="Ryan, College Student"
          title="CEO"
          testimonial="I was completely drained and struggling to keep up with my demanding job. Therapy at Vagus Mind Health helped me set boundaries, manage stress, and regain control over my life. "
        />
      </div>
      <FirstTherapySession
