    ...
    <div className="font-[Poppins]  px-4 lg:px-6">
      <TherapyInfoSection
        introParagraphs={[
          ...
          "Therapy and coaching can help identify productivity roadblocks, improve focus, and create sustainable habits for long-term success.",
        ]}
      ...
      <div className="py-20">
        <CeoCard
          ...
          title="CEO"
          testimonial="As a home-maker, I felt trapped in an endless cycle of exhaustion and sadness. Therapy  with Vagus Mind Health helped me rediscover joy in the little things and regain control of my life."
        />
      </div>
      <FirstTherapySession
...
export default BoostingProductivityTherpy;
