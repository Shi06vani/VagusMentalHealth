...
const adhdFAQs = [
  {
    ...
    answer: "No, ADHD can affect both children and adults, though it is often diagnosed in childhood.",
  },
  {
    question: "Can ADHD be managed without medication?",
    answer: "Yes, ADHD can be managed with therapy, lifestyle changes, and behavioral strategies, though medication is often recommended.",
  },
  {
    question: "Does ADHD affect mental health?",
    answer: "ADHD can impact mental health by increasing risks of anxiety, depression, and difficulties with emotional regulation.",
  },
];
 const issuesData = [
      {
